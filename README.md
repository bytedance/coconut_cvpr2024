...
We only provide the annotation, for those who are interesting to use our annotation will need to download the images from the links: [COCONut-S]([**https://cocodataset.org/#download**](http://images.cocodataset.org/zips/train2017.zip)) [COCONut-B](http://images.cocodataset.org/zips/unlabeled2017.zip) and [relabeled COCO-val](http://images.cocodataset.org/zips/val2017.zip).
