...
if __name__ == "__main__":
    ...
    if args.input:
        ...
        input_list=os.listdir(args.input[0])
        ...
        for path in tqdm.tqdm(input_list, disable=not args.output):
            ...
            panseg_info=predictions['panoptic_seg'][1]
            panseg=predictions['panoptic_seg'][0].clone().cpu().numpy()
            ...
            if args.output:
                if os.path.isdir(args.output):
                    ...
                    out_filename = f'{args.output}/{img_name}.jpg'
